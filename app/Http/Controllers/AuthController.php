...
class AuthController extends Controller
{
    public function __construct(){
        $this->middleware('can:users.login')->only('login');
        //$this->middleware('can:users.registro')->only('registro');
        $this->middleware('can:users.logout')->only('logout');
    }
